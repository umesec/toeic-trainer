...
const FEATURES: {
  ...
  // 基礎: 実力把握 → 語彙
  { icon: 'stethoscope', title: '診断テスト', subtitle: '実力把握・スタート地点を確認', feature: 'quiz', href: '/quiz/diagnosis' },
  { icon: 'book-closed', title: '単語カード', subtitle: 'SRSで効率よく暗記', feature: 'words', href: '/flashcards' },
  { icon: 'abc', title: '単語テスト', subtitle: '4択で腕試し', feature: 'words', href: '/flashcards/test' },
  // リスニング: 耳の基礎訓練 → Part 1〜4 を本番の順に
  { icon: 'headphones', title: '音声変化', subtitle: '聞き取れる耳を作る', feature: 'listening', href: '/listening' },
  { icon: 'pencil-write', title: 'ディクテーション', subtitle: '書き取りで定着', feature: 'listening', href: '/listening/dictation' },
  { icon: 'photo', title: 'Part 1 写真描写', subtitle: '場面に合う文を選ぶ', feature: 'listening', href: '/listening/part1' },
  { icon: 'mic', title: 'Part 2 応答', subtitle: '音声のみで挑戦', feature: 'listening', href: '/listening/part2' },
  { icon: 'chat-bubbles', title: 'Part 3/4 会話・トーク', subtitle: '長文リスニング', feature: 'listening', href: '/listening/part34' },
  // リーディング: Part 5 → 6/7 を本番の順に
  { icon: 'pencil-check', title: 'Part 5 クイズ', subtitle: '文法・語彙の4択', feature: 'quiz', href: '/quiz' },
  { icon: 'newspaper', title: 'Part 6/7 読解', subtitle: '長文問題', feature: 'reading', href: '/quiz/part7' },
  // 仕上げ: 模試 → 振り返り
  { icon: 'chart-up', title: '模試・実力測定', subtitle: '推定スコアを測る', feature: 'mock', href: '/quiz/mock' },
  { icon: 'notebook-flag', title: '間違いノート', subtitle: '解き直しで克服', feature: 'mistakes', href: '/quiz/mistakes' },
  { icon: 'bar-chart', title: '学習分析', subtitle: 'Part別正答率・スコア推移', feature: 'quiz', href: '/stats' },
];
      ...
      <SafeAreaView style={screenStyles.safeArea}>
        <ScrollView contentContainerStyle={screenStyles.scroll} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.statsRow}>
            <StatCard icon="flame" color={theme.warning} label="連続学習" value={`${streakCount}日`} />
            <StatCard
              icon="check-circle"
              color={theme.success}
              label="正答率"
