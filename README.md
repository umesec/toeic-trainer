...
### 🎙️ Part 2 応答問題
- 本番の Part 2 形式 **15問**。質問と応答 (A)(B)(C) を音声のみで聞き、最も適切な応答を選ぶ
- 回答後に質問文・訳・「引っかけの型」の解説を表示（Where→場所、選択疑問文にYes/Noは不可、など）

### ⏱ ミニ模試
- 制限時間 **10分** で Part 2×5問 + Part 5×10問。本番同様、回答中は正誤が表示されない
- 結果画面でリスニング／リーディングのセクション別成績と、間違えた問題の復習リストを表示
- 受験履歴を保存し、スコアの推移を確認できる
